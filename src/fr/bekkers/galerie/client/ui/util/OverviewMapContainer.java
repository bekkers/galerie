...
public class OverviewMapContainer extends SimplePanel {

	private static Logger logger = Logger.getLogger(OverviewMapContainer.class
			.getName());
	...
	public OverviewMapContainer(String largeur, String hauteur) {
		...
		logger.info("overviewMap created");
	}
			...
			googleMap.addTilesLoadedListenerOnce(new TilesLoadedHandler() {
				...
				public void handle() {
					...
					if (length==1) {
						...
						double zoom = googleMap.getZoom()-4;
